...
public class GameStateController : MonoBehaviour
{
    ...
    [SerializeField] RemainTimerController timer;     // RemainTimer コンポーネント参照
    ...
    abstract class BaseState
    {
        ...
        public virtual StateAction OnUpdate()
        {
    ...
    class PlayingState : BaseState
    {
        ...
        public override StateAction OnUpdate()
        {
            // タイマーが終了していたらゲームオーバーへ
            if (!Controller.timer.IsCountingDown())
            {
                Debug.Log(" PlayingState NEXT ");
                return StateAction.STATE_ACTION_NEXT;
            }
